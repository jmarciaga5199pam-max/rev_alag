        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[95vh] overflow-y-auto border-2 border-primary">
            ...
            <div class="p-8">
                <form id="registerForm" method="POST" onsubmit="return validateRegisterForm()">
                    ...
                    <!-- Terms & Conditions -->
                    <div class="mb-8">
                        <div class="flex items-start p-4 bg-pink-50 rounded-lg border border-pink-200">
                            <input type="checkbox" id="terms" name="terms" required disabled
                                data-viewed="false"
                                onclick="return ensureTermsViewed(event);"
                                class="rounded border-pink-300 text-primary focus:ring-primary mt-1 flex-shrink-0 cursor-not-allowed">
                            <label for="terms" class="ml-3 text-sm text-gray-700">
                                <span class="font-medium">I agree to the Terms of Service and Privacy Policy</span>
                                <span class="text-red-500 ml-1">*</span>
                                <p class="mt-1 text-gray-600">
                                    Please
                                    <button type="button" onclick="showTermsModal()" class="text-primary font-semibold underline hover:no-underline">read the Terms &amp; Privacy Policy</button>
                                    first. The checkbox will unlock once you have reviewed and acknowledged them.
                                </p>
                                <p id="termsReadStatus" class="mt-2 text-xs text-pink-700 flex items-center gap-1">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                                    Locked — click the link above to review.
                                </p>
                            </label>
                        </div>
                        <div id="termsError" class="mt-2 text-sm text-red-600 hidden">
                            You must read and agree to the Terms of Service and Privacy Policy to continue.
                        </div>
                    </div>
